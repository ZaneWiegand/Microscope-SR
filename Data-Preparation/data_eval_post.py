...
for i in range(number):
    ...
    j = j+1
    tf.imwrite(
        f'../Data-Post-upsample/10x_eval/10x{j}.tif', img10x[0:450, 0:600])
    tf.imwrite(
        f'../Data-Post-upsample/20x_eval/20x{j}.tif', img20x[0:900, 0:1200])
    j = j+1
    tf.imwrite(
        f'../Data-Post-upsample/10x_eval/10x{j}.tif', img10x[450:900, 0:600])
    tf.imwrite(
        f'../Data-Post-upsample/20x_eval/20x{j}.tif', img20x[900:1800, 0:1200])
    j = j+1
    tf.imwrite(
        f'../Data-Post-upsample/10x_eval/10x{j}.tif', img10x[0:450, 600:1200])
    tf.imwrite(
        f'../Data-Post-upsample/20x_eval/20x{j}.tif', img20x[0:900, 1200:2400])
    j = j+1
    tf.imwrite(
        f'../Data-Post-upsample/10x_eval/10x{j}.tif', img10x[450:900, 600:1200])
    tf.imwrite(
        f'../Data-Post-upsample/20x_eval/20x{j}.tif', img20x[900:1800, 1200:2400])
    j = j+1
    tf.imwrite(
        f'../Data-Post-upsample/10x_eval/10x{j}.tif', img10x[225:675, 300:900])
    tf.imwrite(
        f'../Data-Post-upsample/20x_eval/20x{j}.tif', img20x[450:1350, 600:1800])
# %%
for i in range(number):
    img10x = tf.imread(f'../Data-Post-upsample/10x_origin/10x{i+1}.tif')
    img20x = tf.imread(f'../Data-Post-upsample/20x_origin/20x{i+1}.tif')
