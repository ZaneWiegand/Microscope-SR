...
for i in range(number):
    ...
    j = j+1
    tf.imwrite(f'../Data/10x/10x{j}.tif', img10x[0:900, 0:1200])
    tf.imwrite(f'../Data/20x/20x{j}.tif', img20x[0:900, 0:1200])
    j = j+1
    tf.imwrite(f'../Data/10x/10x{j}.tif', img10x[900:1800, 0:1200])
    tf.imwrite(f'../Data/20x/20x{j}.tif', img20x[900:1800, 0:1200])
    j = j+1
    tf.imwrite(f'../Data/10x/10x{j}.tif', img10x[0:900, 1200:2400])
    tf.imwrite(f'../Data/20x/20x{j}.tif', img20x[0:900, 1200:2400])
    j = j+1
    tf.imwrite(f'../Data/10x/10x{j}.tif', img10x[900:1800, 1200:2400])
    tf.imwrite(f'../Data/20x/20x{j}.tif', img20x[900:1800, 1200:2400])
    j = j+1
    tf.imwrite(f'../Data/10x/10x{j}.tif', img10x[450:1350, 600:1800])
    tf.imwrite(f'../Data/20x/20x{j}.tif', img20x[450:1350, 600:1800])
# %%
for i in range(number):
    img10x = tf.imread(f'../Data/10x_origin/10x{i+1}.tif')
    img20x = tf.imread(f'../Data/20x_origin/20x{i+1}.tif')
