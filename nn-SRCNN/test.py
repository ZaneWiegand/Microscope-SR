...
if __name__ == '__main__':
    weights_file = './weight_output/epoch_100_lr_0.00010000_psnr_32.69_ssim0.91_nqm18.85.pth'
    upscale_factor = 2
    plus = 1
    number = 8
    ...
    weights_file = './weight_output_syn/epoch_100_lr_0.00010000_psnr_36.16_ssim0.93_nqm22.54.pth'
    upscale_factor = 2
    plus = 1
    number = 8
